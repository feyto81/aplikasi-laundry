...
<div class="page-content">
    <div class="container-fluid">
        ...
        <br>
        <div class="row">
            <form action="{{url('admin/cms_users/update/'.$user->id)}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="col-12">
                    <div class="row">
                        <div class="col-xl-8">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-md-10">
                                            <select class="form-select select2" id="outlet_id" name="outlet_id">
                                                ...
                                                <option @if($item->id==$user->outlet_id) selected @endif value="{{ $item->id}}">{{$item->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-md-10">
                                            <select class="form-select select2" id="level_id" name="level_id">
                                                ...
                                                <option @if($row->id==$user->outlet_id) selected @endif value="{{ $row->id}}">{{$row->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
